        ...
        this.data = {
            ...
            experience: [
                ...
                },
                {
                    ...
                    organization: 'Self-employed',
                    dates: '2013 to 2015',
                    description: 'Taught students of various ages, either professionally or as a family favor, in subjects ranging from liberal arts to physics.',
                    skills: [
                        'Essay reviews',
                        'Math practice',
...
var TerminalComponent = /** @class */ (function () {
    ...
    TerminalComponent.prototype.focusDown = function () {
